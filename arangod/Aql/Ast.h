...
/// @brief the AST
        ...
        public:
            ...
            AstNode *createNodeFor(char const *variableName, size_t nameLength, AstNode const *expression,
            ...
            getReferencedAttributesForKeep(AstNode const *, Variable const *searchVariable, bool &);
